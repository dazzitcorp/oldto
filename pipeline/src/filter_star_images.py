...
Usage:
    ...
    ./pipeline/src/filter_star_images.py images.ndjson > images-nonstar.ndjson
"""
...
def is_star_image(record):
    ...
    return (
        "TSPA" in record["license"]
        or "-TS-" in record["uniqueID"]
        or "Toronto Star" in (record["provenance"] or [])
        or "Toronto Star" in (record["rights_holder"] or [])
    )
